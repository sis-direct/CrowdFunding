...
jQuery(document).ready(function() {
    jQuery(".js-reward-element").on("click", function(event){
        event.preventDefault();

        window.parent.document.getElementById("jform_reward_id").value = jQuery(this).data("title");
        window.parent.document.getElementById("jform_reward_id_id").value = jQuery(this).data("id");
        window.parent.closeRewardModal();
    });
});';
	...
	<div id="j-main-container">
		<div id="filter-bar" class="btn-toolbar">
			...
			<div class="btn-group pull-left">
				<button class="btn hasTooltip" type="submit" title="<?php echo JText::_('JSEARCH_FILTER_SUBMIT'); ?>" data-placement="bottom">
					<i class="icon-search"></i>
				</button>
				<button class="btn hasTooltip" type="button" title="<?php echo JText::_('JSEARCH_FILTER_CLEAR'); ?>" onclick="document.getElementById('filter_search').value='';this.form.submit();" data-placement="bottom">
